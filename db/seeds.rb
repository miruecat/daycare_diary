...
c1 = Child.create(first_name: "Liam", last_name: "Smith", birthdate: DateTime.new(2021,2,3), daycare_id: d1.id)
c2 = Child.create(first_name: "Olivia", last_name: "Smith", birthdate: DateTime.new(2020,1,12), daycare_id: d1.id)
c3 = Child.create(first_name: "Noah", last_name: "Williams", birthdate: DateTime.new(2019,4,4), daycare_id: d1.id)
c4 = Child.create(first_name: "Emma", last_name: "Williams", birthdate: DateTime.new(2021,5,3), daycare_id: d1.id)
c5 = Child.create(first_name: "Sophia", last_name: "Miller", birthdate: DateTime.new(2019,12,10), daycare_id: d1.id)
c6 = Child.create(first_name: "Lucas", last_name: "Wilson", birthdate: DateTime.new(2018,9,11), daycare_id: d1.id)
c7 = Child.create(first_name: "Henry", last_name: "Anderson", birthdate: DateTime.new(2020,3,18), daycare_id: d1.id)
c8 = Child.create(first_name: "Isabella", last_name: "Lee", birthdate: DateTime.new(2020,12,25), daycare_id: d1.id)
c9 = Child.create(first_name: "Mary", last_name: "Jones", birthdate: DateTime.new(2020,8,8), daycare_id: d2.id)
c10 = Child.create(first_name: "Grace", last_name: "Jones", birthdate: DateTime.new(2020,8,8), daycare_id: d2.id)
puts "Children added!"
